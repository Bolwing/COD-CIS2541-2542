...
public:
    ...
    friend bool operator > (const date& d, const date& p) {
            if (d.getYear() > p.getYear()) {
                return true;
            }
            else if (d.getMonth() > p.getMonth()) {
                return true;
            }
            else if (d.getDay() > p.getDay()) {
                return true;
            }
            else {
                return false;
    ...
    friend bool operator == (const date& d, const date& p) {
        if ((d.getYear() == p.getYear())&&(d.getMonth() == p.getMonth())&&(d.getDay() == p.getDay())) {
            return true;
        }
        else {
            return false;
    ...
    friend std::istream& operator >>(std::istream& cin, date& target);
...
{
    outs  << source.getMonth() << " " << source.getDay() << " "  << source.getYear();
    return outs;
}
